...
public class TelaCilindro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Calculando Área e Volume do Cilindro");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jTextFieldRaio, javax.swing.GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        saida+= "Raio informado: " + cilindro.getRaio() + "\n";
        saida+= "Altura informada:" + cilindro.getAltura() + "\n";
        saida+= "Área lateral do cilindro: " + cilindro.calculaAreaLateral() + "\n";
        saida+= "Área total do cilindro: " + cilindro.calculaAreaTotal() + "\n";
        saida+= "Volume do cilindro: " + cilindro.calculaVolume();          
        
        jTextAreaSaida.setText(saida);        
        
        }catch(NumberFormatException erro){
            jTextAreaSaida.setText("Entrada inválida!\n" + erro.getMessage());
            JOptionPane.showMessageDialog(null, "Entrada inválida, digite apenas números\n" + erro.getMessage());
        }
        catch(Exception erro){
            jTextAreaSaida.setText("Ocorreu um erro!\n" + erro.getMessage());
            JOptionPane.showMessageDialog(null, "Ocorreu um erro\n" + erro.getMessage());
        }
        finally {
            JOptionPane.showMessageDialog(null, "Fim da exercução do programa!");
        }
